                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-3">
                            {[
                                { icon: <Mail size={18} />, label: 'shreyam484@gmail.com', href: 'mailto:shreyam484@gmail.com', color: '#14b8a6' },
                                { icon: <Linkedin size={18} />, label: 'LinkedIn Profile', href: 'https://www.linkedin.com/in/shreyam8/', color: '#6366f1' },
                                { icon: <Github size={18} />, label: 'GitHub Projects', href: 'https://github.com/Shreyaa386', color: '#a855f7' },
                                { icon: <Phone size={18} />, label: '+91-6266516076', href: 'tel:+916266516076', color: '#f59e0b' },
                            ].map((item, i) => (
                                <motion.a
