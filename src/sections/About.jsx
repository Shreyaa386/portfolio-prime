                ...
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-12 mb-20">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="absolute inset-4 flex items-center justify-center">
                                        <div className="blob-shape w-48 h-48 bg-gradient-to-br from-cyan-400/20 to-orange-400/20 flex items-center justify-center overflow-hidden">
                                            <img src="/image.png" alt="Profile" className="w-full h-full object-cover select-none pointer-events-none" />
                                        </div>
                                    </div>
                        ...
                        <div className="w-full md:w-1/2 flex flex-col justify-center lg:pl-8">
                            ...
                            >
                                I am a <strong>Computer Science Engineering student</strong> with strong skills in full-stack web development and problem solving.
                            </motion.p>
                            <motion.p
                            ...
                            >
                                I have hands-on experience in building scalable applications using the <strong className="text-teal-400">MERN stack</strong> and modern frontend technologies.
                            </motion.p>
                            <motion.p
                            ...
                            >
                                I enjoy solving real-world problems, learning new technologies, and working collaboratively in team environments.
                            </motion.p>
                            ...
                            <div className="grid grid-cols-2 gap-5 lg:gap-6">
                                {[
                                    { value: '2+', label: 'Projects Completed', color: '#14b8a6', glow: 'rgba(20,184,166,0.2)' },
                                    { value: '10+', label: 'Tech Stack', color: '#8b5cf6', glow: 'rgba(139,92,246,0.2)' },
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
                        {[
                            ...
                            },
                            {
                                ...
                                title: 'Web Developer Intern @ Swap Infotech',
                                points: [
                                    'Worked on real-world web development projects',
                                    'Gained experience in frontend + backend development',
                                    'Improved debugging & implementation skills',
                                    'Followed industry workflows and deadlines',
                                ],
                            },
                        ].map((card, i) => (
                            <motion.div
