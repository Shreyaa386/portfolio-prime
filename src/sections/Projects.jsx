...
const projects = [
    {
        ...
        category: 'Frontend Desktop App',
        description: 'Built a custom text editor with undo/redo functionality using linked lists & stacks for state management to implement efficient tracking of user actions.',
        tags: [
        ...
        metrics: [
            { icon: <Zap size={13} />, label: 'Efficient State' },
            { icon: <TrendingUp size={13} />, label: 'O(1) Undo/Redo' },
            { icon: <Shield size={13} />, label: 'Custom Logic' },
        ],
        link: 'https://rewind-rewrite-editor.netlify.app/',
        linkType: 'live',
        accent: '#6366f1',
        ...
        mockupBadges: ['Stacks', 'Linked Lists', 'React'],
    },
    {
        num: '02',
        title: 'Livestock Manager',
        category: 'Full-Stack System',
        description: 'Developed a full-stack livestock management system. Implemented JWT authentication & role-based access, created an analytics dashboard with real-time insights, and added search & data visualization features.',
        tags: [
        ...
        metrics: [
            { icon: <TrendingUp size={13} />, label: 'Real-time Analytics' },
            { icon: <Shield size={13} />, label: 'JWT Auth' },
            { icon: <Zap size={13} />, label: 'Data Vis' },
        ],
        link: 'https://github.com/Shreyaa386/livestock_manager',
        linkType: 'github',
        accent: '#10b981',
        ...
        mockupBadges: ['Dashboard', 'JWT', 'REST API'],
    },
];
                    ...
                    {project.link && project.link !== '#' && (
                        <div className="relative z-[100]">
                            <button
                                ...
                                {project.linkType === 'github' ? <Github size={15} /> : <ExternalLink size={15} />}
                                {project.linkType === 'github' ? 'Source Code' : 'View Live'}
                            </button>
                        </div>
                    )}
                </div>
